...
SECRET_KEY = 'django-insecure-+(op96&^=5q=g81kq(*$f-)#8%z(roq-x&%=3y2v)5x@*4xeeh'
...
STATICFILES_DIRS = [
    BASE_DIR / "surveys/static",  # Point to the static directory in your app
]
...
LOGIN_REDIRECT_URL = 'home'  # URL name for the page to redirect after successful login
